...
export function registerLift(): void {
  registerCallBranch('cpp/range_sort', (funcName, argChildren, _ctx, _argsNode): SemanticNode | null => {
    if (!((funcName === 'sort' || funcName === 'std::sort') && argChildren.length === 2)) return null
