...
const node = (componentId: string, properties: Record<string, unknown> = {}, slots: Record<string, SemanticNode[]> = {}): SemanticNode =>
  ({ componentId, properties, slots } as SemanticNode)
