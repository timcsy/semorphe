/**
 * `cpp:string_find_first_not_of` 的自證測。
 *
 * ## 這一顆搬家順帶治了一個病
 *
 * 它原本與 `find_last_not_of` 共用 `lifters/io.ts` 的一個 case，
...
describe('膠囊自證：cpp:string_find_first_not_of', () => {
  ...
  it('★ generate：產回 s.find_first_not_of(...)', () => {
    const tree = createNode('cpp:program', {}, {
      body: [createNode('cpp:string_find_first_not_of', {}, { obj: [createNode('cpp:var_ref', { name: 's' })],
