...
> ## ✅ **已退場（2026-08-21）——保留為根因的量測紀錄**
>
> spec 167 修了根因，spec 168 做完了 Python 的 23 顆元件。
> 轉變見 [history/118](../history/118-文法不是語言而歸屬要用宣告的.md)
> 與 [history/119](../history/119-全域單槽是在宣告這個系統只有一個語言.md)。
>
> **本檔不再是 in-flight 設計**——它留下來的價值是**那張量測表**
> （47 個節點、降級 0），因為那個數字是「自信地認錯」這個病的唯一實測證據。
>
