...
- [ ] 🎯 **那 9 筆命令式積木——機制都齊了，缺的是【把宣告改過來】**

      🟢 **`cpp_if` 已退場**（2026-08-24，10 → 9）→ [144](history/144-cpp_if退場而擋路的是比對器自己.md)
