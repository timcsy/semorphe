...
describe('Preprocessor Directives', () => {
  describe('#include', () => {
    ...
    it('lifts local include correctly', () => {
      ...
      expect(node).not.toBeNull()
      expect(node!.componentId).toBe('cpp:include_local')
  ...
  describe('#define', () => {
    it('lifts #define correctly', () => {
      ...
      expect(node).not.toBeNull()
      expect(node!.componentId).toBe('cpp:define')
  ...
  describe('using namespace', () => {
    it('lifts using namespace correctly', () => {
      ...
      expect(node).not.toBeNull()
      expect(node!.componentId).toBe('cpp:using_namespace')
...
describe('Declarations', () => {
  ...
  describe('Array declaration', () => {
    it('lifts int arr[10]; correctly', () => {
      ...
      expect(node).not.toBeNull()
      expect(node!.componentId).toBe('cpp:array_declare')
    })
...
describe('Expressions', () => {
  ...
  describe('Literals', () => {
    it('lifts number literal', () => {
      ...
      expect(n!.componentId).toBe('cpp:literal_number')
  ...
  describe('Comparison', () => {
    it.each(['>', '<', '>=', '<=', '==', '!='])('lifts %s', (op) => {
      ...
      expect(n).not.toBeNull()
      expect(n!.componentId).toBe('cpp:compare')
      expect(n!.properties.operator).toBe(op)
    })
  })
  ...
  describe('Logical', () => {
    it.each(['&&', '||'])('lifts %s', (op) => {
      const n = liftExpr(`a ${op} b`)
      expect(n).not.toBeNull()
      expect(n!.componentId).toBe('cpp:logic')
      expect(n!.properties.operator).toBe(op)
    })
    ...
    it('lifts !x (logic_not)', () => {
      ...
      expect(n).not.toBeNull()
      expect(n!.componentId).toBe('cpp:logic_not')
    })
  ...
  describe('Unary negate', () => {
    it('lifts -x (negate)', () => {
      const n = liftExpr('-x')
      expect(n).not.toBeNull()
      expect(n!.componentId).toBe('cpp:negate')
    })
  ...
  describe('Variable reference', () => {
    it('lifts identifier as var_ref', () => {
      ...
      expect(n).not.toBeNull()
      expect(n!.componentId).toBe('cpp:var_ref')
    ...
    it('lifts true as builtin_constant', () => {
      ...
      expect(n).not.toBeNull()
      expect(n!.componentId).toBe('cpp:builtin_constant')
...
describe('Comments', () => {
  it('lifts // line comment (strips prefix)', () => {
    ...
    expect(node).not.toBeNull()
    expect(node!.componentId).toBe('cpp:comment')
  ...
  it('lifts /* block comment */ (strips delimiters)', () => {
    ...
    expect(node).not.toBeNull()
    expect(node!.componentId).toBe('cpp:block_comment')
