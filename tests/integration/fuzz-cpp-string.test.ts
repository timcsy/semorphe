 ...
 * C++ String Fuzz Tests
 *
 * Generated by /component.fuzz cpp hard string 10 on 2026-03-13.
 ...
 *   as `print` component)... Enable when: cout lifter can handle
...
describe('C++ String Fuzz Tests (hard)', () => {
  ...
  // COMPILE_FAIL — find_first_not_of/find_last_not_of not supported as components
})
