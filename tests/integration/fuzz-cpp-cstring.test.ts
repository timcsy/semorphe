...
int main() {
    ...
    expect(concepts.has('cpp:strchr')).toBe(true)
    expect(concepts.has('cpp:strstr')).toBe(true)
    expect(concepts.has('cpp:strlen')).toBe(true)
...
int main() {
    ...
    expect(tree).not.toBeNull()
    const concepts = collectConcepts(tree)
    expect(concepts.has('cpp:strcpy')).toBe(true)
    expect(concepts.has('cpp:strcmp')).toBe(true)
    const generated = roundTripCode(code)
