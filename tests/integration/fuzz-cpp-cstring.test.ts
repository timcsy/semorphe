...
int main() {
    ...
    expect(concepts.has('cpp:cstring_find_char')).toBe(true)
    expect(concepts.has('cpp:cstring_find')).toBe(true)
    expect(concepts.has('cpp:cstring_size')).toBe(true)
...
int main() {
    ...
    expect(tree).not.toBeNull()
    const concepts = collectConcepts(tree)
    expect(concepts.has('cpp:cstring_copy')).toBe(true)
    expect(concepts.has('cpp:cstring_compare')).toBe(true)
    const generated = roundTripCode(code)
