/**
 * Fuzz tests for C++ <cstring> components
 *
...
int main() {
    ...
    expect(components.has('cpp:cstring_find_char')).toBe(true)
    expect(components.has('cpp:cstring_find')).toBe(true)
    expect(components.has('cpp:cstring_size')).toBe(true)
...
int main() {
    ...
    expect(tree).not.toBeNull()
    const components = collectComponents(tree)
    expect(components.has('cpp:cstring_copy')).toBe(true)
    expect(components.has('cpp:cstring_compare')).toBe(true)
    const generated = roundTripCode(code)
