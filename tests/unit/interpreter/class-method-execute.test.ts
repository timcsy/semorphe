...
const assign = (name: string, v: SemanticNode): SemanticNode => n('var_assign', { name }, { value: [v] })
  ...
  n('cpp:class_def', { name: 'Counter' }, {
    public: [
      ...
      n('func_def', { name: 'bump', return_type: 'void' }, {
        params: [],
        body: [assign('n', n('arithmetic', { operator: '+' }, { left: [ref('n')], right: [num(1)] }))],
      }),
    ...
    const withLocal = n('cpp:class_def', { name: 'L' }, {
      public: [
        ...
        n('func_def', { name: 'run', return_type: 'void' }, {
          params: [],
          body: [n('var_declare', { name: '區域', type: 'int' }, { initializer: [num(5)] })],
        }),
      ],
      private: [],
    })
