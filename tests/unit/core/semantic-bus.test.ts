...
describe('SemanticBus', () => {
  ...
  describe('on/emit basics', () => {
    it('should deliver event to subscriber', () => {
      ...
      const tree = { id: '1', componentId: 'cpp:program', properties: {}, children: {} }
  ...
  describe('no subscribers', () => {
    it('should not throw when emitting with no subscribers', () => {
      expect(() => {
        bus.emit('semantic:update', { tree: { id: '1', componentId: 'cpp:program', properties: {}, children: {} }, source: 'blocks' })
      }).not.toThrow()
    })
  })
