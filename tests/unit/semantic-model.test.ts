...
describe('createNode', () => {
  ...
  it('should create a node with all arguments', () => {
    const child = createNode('cpp:number_literal', { value: '5' })
...
describe('nodeEquals', () => {
  it('should return true for identical simple nodes', () => {
    const a = createNode('cpp:number_literal', { value: '42' })
    const b = createNode('cpp:number_literal', { value: '42' })
    expect(nodeEquals(a, b)).toBe(true)
  })

  it('should return false for different concepts', () => {
    const a = createNode('cpp:number_literal', { value: '42' })
    const b = createNode('cpp:string_literal', { value: '42' })
  ...
  it('should ignore metadata and id in comparison', () => {
    const a = createNode('cpp:number_literal', { value: '5' })
    const b = createNode('cpp:number_literal', { value: '5' })
  ...
  it('should compare nested children recursively', () => {
    const childA = createNode('cpp:number_literal', { value: '5' })
    const childB = createNode('cpp:number_literal', { value: '5' })
  ...
  it('should return false for different nested children', () => {
    const childA = createNode('cpp:number_literal', { value: '5' })
    const childB = createNode('cpp:number_literal', { value: '10' })
    const a = createNode('cpp:var_declare', { name: 'x' }, { initializer: [childA] })
    const b = createNode('cpp:var_declare', { name: 'x' }, { initializer: [childB] })
    expect(nodeEquals(a, b)).toBe(false)
  })
  ...
  it('should return false for different number of children keys', () => {
    const child = createNode('cpp:number_literal', { value: '1' })
...
describe('walkNodes', () => {
  it('should visit all nodes in the tree', () => {
    const child1 = createNode('cpp:number_literal', { value: '5' })
    const child2 = createNode('cpp:string_literal', { value: 'hello' })
    const root = createNode('cpp:program', {}, { body: [child1, child2] })

    const visited: string[] = []
    walkNodes(root, (node) => visited.push(node.conceptId))

    expect(visited).toEqual(['cpp:program', 'cpp:number_literal', 'cpp:string_literal'])
  })
  ...
  it('should walk deeply nested trees', () => {
    ...
    expect(visited).toEqual(['cpp:program', 'cpp:func_def', 'cpp:var_declare', 'cpp:number_literal'])
  })
