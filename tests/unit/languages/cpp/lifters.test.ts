...
describe('C++ Declaration Lifters', () => {
  it('should lift declaration with init to var_declare with initializer', () => {
    ...
    expect(result!.children.initializer[0].conceptId).toBe('number_literal')
  })
  ...
  it('should lift forward function declaration with structured params', () => {
    ...
    expect(result!.children.params[1].conceptId).toBe('param_decl')
  ...
  it('should lift array declaration', () => {
    ...
    const result = lifter.lift(node)
    expect(result).not.toBeNull()
    expect(result!.conceptId).toBe('array_declare')
  ...
  it('should lift expression_statement by unwrapping', () => {
    ...
    const result = lifter.lift(node)
    expect(result).not.toBeNull()
    expect(result!.conceptId).toBe('var_ref')
    expect(result!.properties.name).toBe('x')
  })
  ...
  it('should lift assignment_expression to var_assign', () => {
    ...
    const result = lifter.lift(node)
    expect(result).not.toBeNull()
    expect(result!.conceptId).toBe('var_assign')
    expect(result!.properties.name).toBe('x')
...
describe('C++ Expression Lifters', () => {
  ...
  it('should lift true/false to builtin_constant', () => {
    ...
    expect(lifter.lift(trueNode)!.conceptId).toBe('builtin_constant')
    expect(lifter.lift(trueNode)!.properties.value).toBe('true')
    expect(lifter.lift(falseNode)!.conceptId).toBe('builtin_constant')
  ...
  it('should lift null_literal to builtin_constant', () => {
    ...
    const result = lifter.lift(node)
    expect(result).not.toBeNull()
    expect(result!.conceptId).toBe('builtin_constant')
  ...
  it('should lift unary ! to logic_not', () => {
    ...
    const result = lifter.lift(node)
    expect(result).not.toBeNull()
    expect(result!.conceptId).toBe('logic_not')
  ...
  it('should lift unary - to negate', () => {
    ...
    const result = lifter.lift(node)
    expect(result).not.toBeNull()
    expect(result!.conceptId).toBe('negate')
    expect(result!.children.value).toHaveLength(1)
  })
  ...
  it('should degrade unknown unary op (++) to raw_code', () => {
    ...
    const result = lifter.lift(node)
    expect(result).not.toBeNull()
    expect(result!.conceptId).toBe('raw_code')
  })
  ...
  it('should lift subscript_expression to array_access', () => {
    ...
    const result = lifter.lift(node)
    expect(result).not.toBeNull()
    expect(result!.conceptId).toBe('array_access')
    expect(result!.properties.name).toBe('arr')
...
describe('C++ Statement Lifters', () => {
  ...
  it('should lift compound_statement as _compound pseudo-node', () => {
    ...
    const result = lifter.lift(node)
    expect(result).not.toBeNull()
    expect(result!.conceptId).toBe('_compound')
    expect(result!.children.body).toHaveLength(1)
  })
